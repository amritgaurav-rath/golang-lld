...
public class Expense {
    ...
    public static class ExpenseBuilder {
        ...
        public Expense build() {
            if (splitStrategy == null) throw new IllegalStateException("Split strategy is required.");
            if (paidBy == null) throw new IllegalStateException("PaidBy is required.");
            if (participants == null || participants.isEmpty()) throw new IllegalStateException("Participants required.");
